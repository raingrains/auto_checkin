...
function getReward(access_token, signInDay) {
  return axios(rewardURL, {
    ...
    headers: {
      ...
      'x-device-id':'b1cd89865b540df7e5b40f24e816c3b1f697b3cd3da94fe2a555e4f048f1ace8',
      'x-nonce':'2428d5ce-cec3-4a31-a41e-89e83d58f3a1',
      'x-signature':'d8f32123ef143631d75067cc23eb9c1fdc16b60a8f8b05b5d351b4ae3ffdd14c473553b3a611024fb7d22cad879f18565afc72e4640c657c2ec8f3ac0aef6b4800',
      'x-signature-v2':'65149ba566c6360c83b8f4f750a15abf609c963f',
      'x-timestamp':Date.now()
    },
  })
    .then(d => d.data)
    .then(json => {
      console.log('领取奖励：', json)
      if (!json.success) {
